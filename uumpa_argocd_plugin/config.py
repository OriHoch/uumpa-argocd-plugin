...
def get_argocd_app_spec_env_vars():
    return {
        ...
        'ARGOCD_ENV_GENERATE_TEMPLATE_PLUGIN_FUNCTIONS': os.environ.get('ARGOCD_ENV_GENERATE_TEMPLATE_PLUGIN_FUNCTIONS'),
    }
...
ARGOCD_ENV_GENERATE_TEMPLATE_PLUGIN_FUNCTIONS = argocd_app_spec_env_vars['ARGOCD_ENV_GENERATE_TEMPLATE_PLUGIN_FUNCTIONS']
